...
const articles = [
            {
                id: 'mamdani-rent-control-nyc-2026',
                title: 'Does rent control work? Mamdani’s Pinnacle setback revives housing debate',
                publication: 'Scotsman Guide Article',
                genre: 'News & Analysis',
                date: '2026-01-21',
                summary: "Soaring operating costs and capped revenue lead to capital flight, raising questions about the efficacy of regulating rents",
                article_url: 'https://www.scotsmanguide.com/news/does-rent-control-work-mamdani-pinnacle-setback-revives-housing-debate/',
                tags: ['Customer Experience', 'Rules & Regulations','Legal Proceedings', 'Government Affairs'],
            },
            {
                id: 'construction-sector-sounds-alarm-in-data-vacuum-dec-2025',
                title: 'Private sector sounds alarm in data vacuum as top construction firms reveal compressed margins',
                publication: 'Scotsman Guide Article',
                genre: 'News & Analysis',
                date: '2025-12-23',
                summary: "With key housing data delayed till January, construction firms earnings offer insight into the industry",
                article_url: 'https://www.scotsmanguide.com/news/private-sector-sounds-alarm-in-data-vacuum-as-top-construction-firms-reveal-compressed-margins/',
                tags: ['Data & Trends', 'Construction', 'Real Estate'],
            },
            {
                id: 'immmigrant-share-construction-workforce-apr-2026',
                title: 'Immigrant workers reach record share of U.S. construction workforce',
                publication: 'Scotsman Guide Article',
                genre: 'News & Analysis',
                date: '2026-04-06',
                summary: "Amid labor shortages, NAHB data shows more than half of construction workers are foreign-born in key trades like drywall and roofing",
                article_url: 'https://www.scotsmanguide.com/news/immigrant-workers-reach-record-share-of-us-construction-workforce/',
                tags: ['Data & Trends', 'Construction', 'Real Estate'],
            },
            {
                id: 'land-prices-builder-demand-apr-2026',
                title: 'U.S. land prices cool as builder demand softens',
                publication: 'Scotsman Guide Article',
                genre: 'News & Analysis',
                date: '2026-04-21',
                summary: "Vacant land prices have begun to ebb following a 77% spike since the COVID-19 pandemic",
                article_url: 'https://www.scotsmanguide.com/news/us-land-prices-cool-as-builder-demand-softens/',
                tags: ['Data & Trends', 'Construction', 'Real Estate'],
            },
            {
                id: 'builder-sentiment-erodes-dec-2025',
                title: 'Builder sentiment ends 2025 in negative territory as tariffs and costs erode confidence',
                publication: 'Scotsman Guide Article',
                genre: 'News & Analysis',
                date: '2025-12-18',
                summary: "Despite a rise in future sales expectations, survey data reflects persistent industry gloom",
                article_url: 'https://www.scotsmanguide.com/news/home-builder-sentiment-ends-2025-in-negative-territory/',
                tags: ['Construction', 'Data & Trends', 'Real Estate'],
            },
            {
                id: 'downpayment-timeline-improves-dec-2025',
                title: 'Downpayment savings timeline improves, but remains double pre-pandemic norms',
                publication: 'Scotsman Guide Article',
                genre: 'News & Analysis',
                date: '2025-12-29',
                summary: "Timelines have nearly halved since the 2022 peak, but high prices and thinner savings account persist in the post-pandemic era",
                article_url: 'https://www.scotsmanguide.com/news/downpayment-savings-timeline-improves-but-remains-double-pre-pandemic-norms/',
                tags: ['Mortgage', 'Data & Trends'],
            },
            {
                id: 'rocket-sues-california-broker-for-fraud-jan-2026',
                title: 'Rocket Mortgage sues California broker, alleging fraud on loan applications',
                publication: 'Scotsman Guide Article',
                genre: 'News & Analysis',
                date: '2026-02-05',
                summary: "Rocket Mortgage's lawsuit alleges Sharp Loan concealed a borrowers’ preexisting debt with a rival lender, leading to over $194,000 in losses",
                article_url: 'https://www.scotsmanguide.com/news/rocket-mortgage-sues-california-broker-alleging-fraud-on-loan-applications/',
                tags: ['Mortgage', 'Legal Proceedings'],
            },
             {
                id: 'investors-snap-up-la-properties-dec-2025',
                title: 'Investors snap up 40% of vacant lots in fire-afflicted LA neighborhoods as listings surge',
                publication: 'Scotsman Guide Article',
                genre: 'News & Analysis',
                date: '2025-12-30',
                summary: "Homeowners in the Los Angeles area are increasingly selling their properties to investors in the wake of the devastating wildfires",
                article_url: 'https://www.scotsmanguide.com/news/investors-snap-up-40-percent-of-vacant-lots-in-fire-afflicted-la-neighborhoods/',
                tags: ['Real Estate'],
            },
             {
                id: 'bipartisan-alarm-mounts-jan-2026',
                title: 'Bipartisan alarm mounts over DOJ subpoena of Fed Chair Powell',
                publication: 'Scotsman Guide Article',
                genre: 'News & Analysis',
                date: '2026-01-12',
                summary: "Political leaders from both sides of the aisle have voiced concerns following news of a criminal probe of Jerome Powell",
                article_url: 'https://www.scotsmanguide.com/news/bipartisan-alarm-mounts-over-doj-subpoenas-of-fed-chair-powell/',
                tags: ['Government Affairs', 'Legal Proceedings', 'Federal Reserve'],
            },
             {
                id: 'lawsuit-accuses-rocket-of-illegal-steering-jan-2026',
                title: 'Class action lawsuit accuses Rocket of ‘illegal steering’ scheme',
                publication: 'Scotsman Guide Article',
                genre: 'News & Analysis',
                date: '2026-01-27',
                summary: "Rocket Companies denies the allegations that it violated federal law by pushing consumers to its loan products regardless of better rates elsewhere",
                article_url: 'https://www.scotsmanguide.com/news/class-action-lawsuit-accuses-rocket-of-illegal-steering-scheme/',
                tags: ['Legal Proceedings', 'Mortgage'],
            },
             {
                id: 'housing-value-doubles-to-55-trillion-feb-2026',
                title: 'U.S. housing value doubles to $55 trillion since 2006 as supply shortages persist',
                publication: 'Scotsman Guide Article',
                genre: 'News & Analysis',
                date: '2026-02-10',
                summary: "Zillow’s 20-year retrospective reveals how price swings and construction gaps have reshaped the American housing landscape",
                article_url: 'https://www.scotsmanguide.com/news/us-housing-value-doubles-to-55-trillion-since-2006-as-supply-shortages-persist/',
                tags: ['Mortgage', 'Data & Trends'],
            },
                {
                id: 'partial-govt-shutwdown-freezes-flood-insurance-feb-2026',
                title: 'Partial government shutdown freezes NFIP flood insurance, disrupts HUD operations',
                publication: 'Scotsman Guide Article',
                genre: 'News & Analysis',
                date: '2026-02-02',
                summary: "The political deadlock over immigration enforcement is expected to prolong market uncertainty and delay thousands of housing transactions ",
                article_url: 'https://www.scotsmanguide.com/news/partial-government-shutdown-freezes-nfip-flood-insurance-disrupts-hud-operations/',
                tags: ['Government Affairs', 'Rules & Regulations'],
            },
             {
                id: 'job-openings-fall-feb-2026',
                title: 'U.S. job openings fall and layoffs soar, chilling an already tepid labor market',
                publication: 'Scotsman Guide Article',
                genre: 'News & Analysis',
                date: '2026-02-05',
                summary: "Steep declines in professional and retail vacancies drove the reduction in job openings across the economy",
                article_url: 'https://www.scotsmanguide.com/news/us-job-openings-fall-and-layoffs-soar-chilling-an-already-tepid-labor-market/',
                tags: ['Monetary Policy', 'Data & Trends'],
            },
             {
                id: 'survey-lenders-turn-to-ai-jan-2023',
                title: 'Survey: Lenders increasingly turn to AI and automation to curb costs and drive growth',
                publication: 'Scotsman Guide Article',
                genre: 'News & Analysis',
                date: '2026-01-30',
                summary: "Prioritizing long-term growth over immediate profitability, lenders are embracing agentic AI",
            ...
            },
             {
            ...
            },
              {
                ...
                genre: 'News & Analysis',
                date: '2026-02-06',
                summary: "The Federal Housing Finance Agency justified the rollback by citing a need to align with new administration priorities",
                article_url: 'https://www.scotsmanguide.com/news/fhfa-finalizes-repeal-of-biden-era-equitable-housing-regulations/',
                tags: ['Government Affairs', 'Rules & Regulations'],
            },
             {
                id: 'tillis-stands-firm-fed-feb-2026',
                title: 'Tillis stands firm on Fed chair blockade as Scott breaks silence on Powell probe',
                publication: 'Scotsman Guide Article',
                genre: 'News & Analysis',
                date: '2026-02-04',
                summary: "Despite Sen. Thom Tillis’ resolve, Sen. Tim Scott is confident Kevin Warsh’s nomination will proceed",
                article_url: 'https://www.scotsmanguide.com/news/tillis-stands-firm-on-fed-chair-blockade-as-scott-breaks-silence-on-powell-probe/',
                tags: ['Government Affairs', 'Legal Proceedings', 'Federal Reserve'],
            },
            {
